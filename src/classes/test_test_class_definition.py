...
def test_class_definition():
    ...
    assert greeter.say_hello() == 'Hello, My name is Fareed. I am 22 years old.'
    greeter.change_age(23)
    assert greeter.say_goodbye() == 'Goodbye Fareed'
    assert greeter.say_hello() == 'Hello, My name is Fareed. I am 23 years old.'
